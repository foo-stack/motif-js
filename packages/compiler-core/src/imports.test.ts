...
describe('findMotifBindings', () => {
  it('picks up named imports from motif sources', () => {
    const body = programBody(`import { Box, Stack } from '@motif-js/react-web';`);
  ...
  it('handles aliased imports', () => {
    const body = programBody(`import { Box as MotifBox } from '@motif-js/react-web';`);
    const bindings = findMotifBindings(body);
  ...
  it('ignores non-primitive named exports', () => {
    const body = programBody(`import { Theme, Container } from '@motif-js/react-web';`);
    const bindings = findMotifBindings(body);
...
describe('bindingForJsxName', () => {
  ...
  it('returns undefined for unknown identifiers', () => {
    const bindings = findMotifBindings(programBody(`import { Box } from '@motif-js/react-web';`));
