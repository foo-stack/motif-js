...
- **Fresh v1.0.0 on the `@usemotif/*` scope.** No behaviour change in this package; bumped to track the workspace rebrand (renamed from `@motif-js/icons`). See the [v2 → v3 migration guide](https://usemotif.dev/migrating/v2-to-v3).
