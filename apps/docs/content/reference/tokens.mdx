...
diataxis: reference
covers: ['lightTheme', 'darkTheme', 'colors', 'space', 'sizes', 'radii', 'fontFamilies', 'fontSizes', 'fontWeights', 'lineHeights', 'shadows', 'durations', 'easings', 'opacities', 'zIndices', 'animations']
...
The `@usemotif/tokens` package ships two ready-to-use themes and the fourteen primitive scales
