...
<CodeBlock lang="tsx" code={`import { ThemeProvider, Theme, Box } from '@motif-js/react';
...
- [`useTheme`, `useThemeName`](/reference/use-theme) — read the active theme from a component.
