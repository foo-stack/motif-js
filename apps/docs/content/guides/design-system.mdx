...
<CodeBlock lang="ts" filename="theme/light.ts" code={`import { createTheme } from '@motif-js/react';
...
<CodeBlock lang="tsx" filename="components/Surface.tsx" code={`import { styled } from '@motif-js/react';
...
<CodeBlock lang="tsx" filename="components/Card.tsx" code={`import { Surface, Heading, Text, Stack } from './primitives';
...
<CodeBlock lang="ts" filename="index.ts" code={`export { lightTheme, darkTheme } from './theme';
