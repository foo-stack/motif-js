...
<CodeBlock lang="ts" filename="theme/light.ts" code={`import { createTheme } from 'usemotif';
...
<CodeBlock lang="tsx" filename="components/Surface.tsx" code={`import { styled } from 'usemotif';
