...
<CodeBlock lang="tsx" code={`import { createTheme } from '@motif-js/react';
...
<CodeBlock lang="tsx" code={`import { ThemeProvider } from '@motif-js/react';
...
<CodeBlock lang="tsx" code={`import { Theme } from '@motif-js/react';
