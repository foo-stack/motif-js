...
<CodeBlock lang="tsx" code={`import { createTheme } from 'motif-js';
...
<CodeBlock lang="tsx" code={`import { ThemeProvider } from 'motif-js';
...
<CodeBlock lang="tsx" code={`import { Theme } from 'motif-js';
